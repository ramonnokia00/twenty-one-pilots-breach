            ...
            <div className=" w-full h-[450px] bg-[#424651]/20">
                ...
                <div className="flex justify-between">
                    ...
                    <div className=" bg-black w-[200px] rounded mt-6 gap-3">
                        <img src={imagemCardDoubtDemo} alt="" className="w-[200px] h-[150px] mt-6 "/><b className=" bg-[#FFD900] rounded hover:bg-yellow-500 duration-150 cursor-pointer">Ouça Agora!</b>
                        <p className="mt-3 text-red-600 flex">Enquanto o album não saiu ouça agora o ultimo EP lançado.</p>
